...
/*
 * The LPI TLMM block spans 32 pads from 0x62b40000. Pads 0..17 carry the
 * secondary MI2S/TDM interface (speaker amps on sunfish) among others; pads
 * 18..31 are the soundwire/dmic set.
 */
...
static const char * const sec_mi2s_groups[] = { "gpio8", "gpio9", "gpio10", "gpio11" };
...
static const struct lpi_pingroup sm7150_groups[] = {
	...
	LPI_PINGROUP(8, LPI_NO_SLEW, _, _, sec_mi2s, _),
	LPI_PINGROUP(9, LPI_NO_SLEW, _, _, sec_mi2s, _),
	LPI_PINGROUP(10, LPI_NO_SLEW, _, _, _, sec_mi2s),
	LPI_PINGROUP(11, LPI_NO_SLEW, _, sec_mi2s, _, _),
